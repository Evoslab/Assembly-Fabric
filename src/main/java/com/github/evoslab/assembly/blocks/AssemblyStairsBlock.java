package com.github.evoslab.assembly.blocks;
...
public class AssemblyStairsBlock extends Block implements Waterloggable {
    ...
    public AssemblyStairsBlock(BlockState baseBlockState, Settings settings) {
        super(settings);
